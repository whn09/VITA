...
# wget https://github.com/snakers4/silero-vad/blob/v4.0/files/silero_vad.onnx -O web_demo/wakeup_and_vad/resources/silero_vad.onnx
# wget https://github.com/snakers4/silero-vad/blob/v4.0/files/silero_vad.jit -O web_demo/wakeup_and_vad/resources/silero_vad.jit
